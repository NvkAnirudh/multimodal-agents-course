<p align="center">
    ...
    <h1 align="center">⚡ Recollect API ⚡</h1>
    <h3 align="center">A FastAPI backend for serving Recollect's video tools</h3>
</p>

Welcome to the Recollect API!


This is the layer that connects it all—exposing the tools and prompts defined by Recollect MCP and making them accessible through a clean, efficient FastAPI interface.


Recollect API is one of three core components of the full Recollect stack (take a peek at the [Docker Compose file](../docker-compose.yml) to see them all), and while it works best with its companions, it can also run solo if needed.
...
Recollect API is built with Python and FastAPI, and uses uv for managing dependencies.
